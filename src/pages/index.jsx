      ...
      <div className="overflow-hidden h-screen bg-primary font-mono">
        ...
        <div className="flex">
          <div className={`px-12 py-24 ${open ? 'mt-52': ''} text-info flex md:w-screen z-1 lg:w-3/5 flex-col z-0 lg:px-24 md:p-48`}>
            ...
            >
              My name is <span className="text-highlight">Von Gerwil Tiu</span>
            </motion.h1>
            <motion.h2
              initial={{ y:10, opacity: 0 }}
              animate={{ y:0, opacity: 1 }}
            ...
            >
              ...
              <a href="https://drive.google.com/drive/u/0/folders/1S3MB2uC30cm_WYkMX05euM5_KPiKg30J/view" target="_blank" className="border-highlight mb-3 border-2 p-2 rounded w-1/2 text-highlight font-bold hover:bg-highlight hover:text-light text-center lg:ml-2 md:w-1/5">Download Resume</a>
            </motion.div>
          </div>
          <motion.div
            initial={{ y: 10, opacity: 0 }}
