                        ...
                        <div className="flex flex-row my-8 justify-between">
                            <div className="w-5/6">
                                <motion.p
                                    ...
                                    transition={{ delay: 1 }}
                                >
                                    Hello, My name is Von Gerwil Tiu. I am a Software Developer from Sampaloc, Manila, Philippines.
                                    Currently, I am employed by Itech as Software Developer.
                                </motion.p>
                                <br />
                                <motion.p
                                    initial={{ y: 20, opacity: 0 }}
                                ...
                                >
                                    I love working on a variety of technologies including Web Application and Deep Learning.
                                    My goal is to build highly performant applications that solve problems and provide users
                                ...
                                >
                                    ...
                                    <div className="w-5/6">
                                        ...
                                        <div className="h-auto w-auto text-center float-left">
                                            <img className="p-1" src="https://img.shields.io/badge/laravel-%2320232a.svg?style=for-the-badge&logo=laravel&logoColor=%FF0000" alt="" />
                                        </div>
                                        <div className="h-auto w-auto text-center float-left">
                                        ...
                                        <div className="h-auto w-auto text-center float-left">
                                            <img className="p-1" src="https://img.shields.io/badge/php-%2320232a.svg?style=for-the-badge&logo=php&logoColor=%#8993be" alt="" />
                                        </div>
                                      {/*  <div className="h-auto w-auto text-center float-left">
