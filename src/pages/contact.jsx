        ...
        <>
            <div className="overflow-x-hidden text-info h-screen bg-primary font-mono">
                    ...
                    >
                     ...
                     {/*   <a href="https://twitter.com/AayushK_47" target="_blank" rel="noopener noreferrer">
                       ...
                       {/* <a href="https://github.com/AayushK47" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://www.instagram.com/iamvn/" target="_blank" rel="noopener noreferrer">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#EAB41E" height="25" width="25">
                ...
                {/*        <a href="https://showwcase.aayushkurup.dev/" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://www.facebook.com/VnTiu" target="_blank" rel="noopener noreferrer">
                          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 216 216">
                            <path d="M141.05 216V119.41h28.69l4.31-33.31H141.05V66.72c0-9.63 2.68-16.21 16.58-16.21H182V17.31S166.84 0 147.34 0c-28.54 0-47.66 17.38-47.66 49.05v27.05H76.9v33.31h22.78V216h41.37z" fill="#EAB41E"/>
                            <path d="M605 920c-14-6-3-9 40-9 42-1 56 2 45 9-18 12-58 12-85 0z" transform="matrix(.1 0 0 -.1 0 130)" fill="#EAB41E"/>
                          </svg>
                        </a>
                    </motion.div>
                </div>
